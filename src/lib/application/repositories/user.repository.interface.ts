...
export interface IUserRepository {
  ...
  findByUsernameWithRoles(username: string): Promise<{ id: string; username: string; avatar: string; bio?: string | null; banner?: string | null; customStatus?: string | null; roles: { id: string; name: string }[]; createdAt: Date; } | null>;

...
export default function LoadingRoom() {
  ...
  return (
    <div className="flex flex-col h-screen max-h-[calc(100vh-6rem)] bg-background">
      {/* Skeleton Header */}
      <div className="flex items-center justify-between border-b rounded-t-xl bg-card/50 px-4 py-4 animate-pulse">
        <div className="flex items-center gap-2">
          <Hash className="text-muted-foreground" />
          <div className="w-24 h-4 rounded bg-muted" />
          <div className="h-5 w-18 px-2 py-1 rounded-md bg-muted flex items-center" />
        </div>
